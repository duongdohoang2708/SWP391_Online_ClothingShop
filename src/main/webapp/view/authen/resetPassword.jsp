...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Reset Password || Clothing</title>
                        ...
                        <form action="authen?action=reset-password" method="post">
                            <div class="login-reg">
                                ...
                                <div class="input-box mb-20">
                                    ...
                                    <input type="password" class="info" placeholder="Enter new password" name="newPassword" required>
                                </div>

                                <div class="input-box">
                                    <label class="control-label">Confirm New Password</label>
                                    <input type="password" class="info" placeholder="Confirm new password" name="confirmPassword" required>
                                </div>
                            </div>
                            <div class="frm-action">
                                <div class="input-box tci-box">
                                    <a href="#" onclick="this.closest('form').submit(); return false;" class="btn-def btn2">Reset Password</a>
                                </div>
                            </div>
                        </form>
                    </div>
