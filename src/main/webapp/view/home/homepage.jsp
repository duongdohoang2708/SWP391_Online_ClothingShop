...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <jsp:include page="../../common/home/css-home.jsp"></jsp:include>
            <style>
                .slider-img img {
                    width: 100%; /* Ảnh sẽ chiếm toàn bộ chiều rộng của phần tử chứa */
                    max-height: 100%; /* Giới hạn chiều cao để ảnh không quá to */
                    object-fit: cover; /* Cắt ảnh để phù hợp với khung */
                    border-radius: 10px; /* Bo góc nhẹ cho ảnh nếu muốn */
                }
        ...
        <body>
            ...
            <jsp:include page="../../common/home/header-homepage.jsp"></jsp:include>
                ...
                <!--slider area start-->
               <div id="slider-container" class="slider-area pos-rltv carosule-pagi cp-line">
    <div class="active-slider">
        <c:forEach var="story" items="${stories}">
            <div class="single-slider pos-rltv">
                <div class="slider-img">
                    <img src="${pageContext.request.contextPath}/${story.thumbnail}" 
                         alt="${story.title}" style="width: 100%; max-height: 500px; object-fit: cover;">
                </div>
                <div class="slider-content pos-abs">
                    <h4>New Story</h4>
                    <h1 class="uppercase pos-rltv underline" style="color: #FAFAFA;">${story.title}</h1>
                    <p style="color: #FAFAFA;">${story.description}</p>
        ...
        <script>
            function activateStory(storyId) {
                $.ajax({
                    url: "/manage-story?action=activate",
                    type: "POST",
                    data: {storyId: storyId},
                    success: function (response) {
                        if (response.success) {
                            loadLatestStories(); // Cập nhật lại slider sau khi active
                        } else {
                            alert("Failed to activate story!");
                        }
                    },
                    error: function () {
            ...
            function loadLatestStories() {
                $.ajax({
                    ...
                    error: function () {
                        alert("Error loading latest stories.");
                    }
                });
            }
