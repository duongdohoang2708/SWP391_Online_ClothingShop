...
<main class="dashboard-main">
  ...
  <ul class="d-flex align-items-center gap-2">
    ...
    <form action="/blog?action=create" method="post" enctype="multipart/form-data" class="d-flex flex-column gap-20">
        <!-- Blog Title -->
        <div>
        ...
        <!-- Upload Thumbnail -->
        <div>
            <label class="form-label fw-bold text-neutral-900" for="upload-file">Upload Thumbnail:</label>
            <input id="upload-file" type="file" name="thumbnail" class="form-control border border-neutral-200 radius-8" accept="image/*" required>
        </div>
