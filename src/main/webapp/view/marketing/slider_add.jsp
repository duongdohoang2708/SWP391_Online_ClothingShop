...
<html lang="en" data-theme="light">
    ...
    <!-- Mirrored from wowdash.wowtheme7.com/demo/slider_detail.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Feb 2025 04:44:35 GMT -->
    <head>
        <meta charset="UTF-8">
        ...
        <main class="dashboard-main">
            ...
            <div class="dashboard-main-body">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                    <h6 class="fw-semibold mb-0">Add Slider</h6>
    ...
    <!-- Mirrored from wowdash.wowtheme7.com/demo/slider_detail.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Feb 2025 04:44:36 GMT -->
</html>
