                            ...
                            <div>
                                ...
                                <div class="upload-image-wrapper">
                                    <div class="uploaded-img d-none position-relative h-160-px w-100 border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50">
                                        ...
                                        <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover" src="${pageContext.request.contextPath}/assets/images/user.png" alt="image">
                                    </div>
                                    ...
                                    <button type="button" class="btn btn-primary-600 radius-8">Cancel</button>
                        </form>
                    </div>
                </div>
            </div>
