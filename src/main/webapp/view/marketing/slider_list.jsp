...
<!--        <div class="row gy-4">
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6">
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-24">
                        <a href="blog-details.html" class="w-100 max-h-194-px radius-8 overflow-hidden">
                            <img src="${pageContext.request.contextPath}/assets/images/blog/blog2.png" alt="" class="w-100 h-100 object-fit-cover">                        
                        </a>
                        <div class="mt-20">
                            <div class="d-flex align-items-center gap-6 justify-content-between flex-wrap mb-16">
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6">
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-24">
                        <a href="blog-details.html" class="w-100 max-h-194-px radius-8 overflow-hidden">
                            <img src="${pageContext.request.contextPath}/assets/images/blog/blog3.png" alt="" class="w-100 h-100 object-fit-cover">                        
                        </a>
                        <div class="mt-20">
                            <div class="d-flex align-items-center gap-6 justify-content-between flex-wrap mb-16">
                                <a href="blog-details-2.html" class="px-20 py-6 bg-neutral-100 rounded-pill bg-hover-neutral-300 text-neutral-600 fw-medium">Workshop</a>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6">
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-24">
                        <a href="blog-details.html" class="w-100 max-h-194-px radius-8 overflow-hidden">
                            <img src="${pageContext.request.contextPath}/assets/images/blog/blog4.png" alt="" class="w-100 h-100 object-fit-cover">                        
                        </a>
                        <div class="mt-20">
                            <div class="d-flex align-items-center gap-6 justify-content-between flex-wrap mb-16">
                                <a href="blog-details-2.html" class="px-20 py-6 bg-neutral-100 rounded-pill bg-hover-neutral-300 text-neutral-600 fw-medium">Workshop</a>
                ...
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-0">
                        <a href="blog-details.html" class="w-100 max-h-266-px radius-0 overflow-hidden">
                            <img src="${pageContext.request.contextPath}/assets/images/blog/blog5.png" alt="" class="w-100 h-100 object-fit-cover">                        
                        </a>
                        <div class="p-20">
                            <h6 class="mb-16">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-6">
                                <div class="d-flex align-items-center gap-8">
                                    <img src="${pageContext.request.contextPath}/assets/images/user-list/user-list1.png" alt="" class="w-40-px h-40-px rounded-circle object-fit-cover">
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6">
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-0">
                        <a href="blog-details.html" class="w-100 max-h-266-px radius-0 overflow-hidden">
                            <img src="${pageContext.request.contextPath}/assets/images/blog/blog6.png" alt="" class="w-100 h-100 object-fit-cover">                        
                        </a>
                        <div class="p-20">
                            <h6 class="mb-16">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-6">
                                <div class="d-flex align-items-center gap-8">
                                    <img src="${pageContext.request.contextPath}/assets/images/user-list/user-list2.png" alt="" class="w-40-px h-40-px rounded-circle object-fit-cover">
                                    <div class="d-flex flex-column">
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6">
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-0">
                        <a href="blog-details.html" class="w-100 max-h-266-px radius-0 overflow-hidden">
                            <img src="${pageContext.request.contextPath}/assets/images/blog/blog7.png" alt="" class="w-100 h-100 object-fit-cover">                        
                        </a>
                        <div class="p-20">
                            <h6 class="mb-16">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-6">
                                <div class="d-flex align-items-center gap-8">
                                    <img src="${pageContext.request.contextPath}/assets/images/user-list/user-list3.png" alt="" class="w-40-px h-40-px rounded-circle object-fit-cover">
                                    <div class="d-flex flex-column">
                                        <h6 class="text-sm mb-0">John Doe</h6>
                                        <span class="text-xs text-neutral-500">1 day ago</span>
                                    </div>
                ...
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-0">
                        ...
                        <div class="p-20">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-6">
                                <div class="d-flex align-items-center gap-8">
                                    <img src="${pageContext.request.contextPath}/assets/images/user-list/user-list5.png" alt="" class="w-40-px h-40-px rounded-circle object-fit-cover">
                                    <div class="d-flex flex-column">
                                        <h6 class="text-sm mb-0">John Doe</h6>
                                        <span class="text-xs text-neutral-500">1 day ago</span>
                                    </div>
